...
def custom_loss(predictions, targets):
    ...
    under_penalty = 300  # Adjust this factor to penalize underestimation
...
plt.plot(data.index[-look_back:], data['temp_max'].values[-look_back:], label='Past Temp Min')
