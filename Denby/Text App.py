...
class App():
    def __init__(self):
        ...
        self.set_text_field.grid(row=1, column=0, pady=10, sticky='NWES', padx=5)
        ...
        self.set_color_field.grid(row=2, column=0, sticky='NWES', pady=10, padx=5)
        ...
        self.reverse_text.grid(row=3, column=0, sticky='NWES', pady=10, padx=5)
