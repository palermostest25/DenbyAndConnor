                ...
                if pygame.sprite.collide_mask(gamer_Dino,c):
                    ...
                    if pygame.mixer.get_init() != None:
                        ...
                        with open('resources/High_Score.txt', 'w') as f:
                            ...
                            print(f"Score: {gamer_Dino.score}")
                            print(f"High Score: {highest_scores}")
                        die_sound.play()
